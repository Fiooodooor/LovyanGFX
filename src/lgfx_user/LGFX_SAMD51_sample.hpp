...
// Configuration example for using LovyanGFX with custom settings on SAMD51
...
/*
 ...
 for example, if configuring an ILI9341 with SPI connection on a FeatherWing M4,
...
// SPI bus settings
      cfg.sercom_index = 1;         // Specify the SERCOM number to use
      cfg.spi_mode = 0;             // Set SPI communication mode (0 ~ 3)
      cfg.freq_write = 24000000;    // SPI clock for transmission (rounded to a value that divides the CPU clock evenly)
      cfg.freq_read  = 12000000;    // SPI clock for reception
      cfg.pin_sclk = lgfx::samd51::PORT_A | 17; // Set SPI SCLK pin number
      cfg.pin_mosi = lgfx::samd51::PORT_B | 23; // Set SPI MOSI pin number
      cfg.pin_miso = lgfx::samd51::PORT_B | 22; // Set SPI MISO pin number (-1 = disable)
      cfg.pin_dc   = lgfx::samd51::PORT_A | 20; // Set SPI D/C pin number  (-1 = disable)
...
/*
// I2C bus settings
      cfg.sercom_index = 2;         // Specify the SERCOM number to use
      cfg.freq_write  = 400000;     // Clock for transmission
      cfg.freq_read   = 400000;     // Clock for reception
      cfg.pin_sda = lgfx::samd51::PORT_A | 12; // Set I2C SDA pin number
      cfg.pin_scl = lgfx::samd51::PORT_A | 13; // Set I2C SCL pin number
...
//*/
    ...
    { // Configure display panel control settings.
      ...
      cfg.pin_cs   = lgfx::samd51::PORT_A | 19; // Pin number connected to CS   (-1 = disable)
